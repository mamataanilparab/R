...
setwd("C:\\Users\\Larry Williams\\Desktop\\Mamata\\Edvancer\\data\\data")
...
setwd("C:\\Users\\Larry Williams\\Desktop\\Mamata\\Edvancer\\R\\Data\\Data\\namesbystate")
...
## ------------------------------------------------------------------------
#We can use comma or ampersand to represent AND condition
...
# extracting date time in specIfic format from POSIXt object 
...
x=c("lalita","lalita sachan","ankit sharma","lalti kumar")
