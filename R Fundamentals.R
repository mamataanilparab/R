...
## ------------------------------------------------------------------------
## naming rules
1.more=2.34 #is not valid
one.more=2.34
onemoreobject=2.34
one.more.object=2.34

# we can use dots(.) and underscore ( _ )
# we cannot have other special characters in the name
# we can use numbers also in object , BUT not at the begining
